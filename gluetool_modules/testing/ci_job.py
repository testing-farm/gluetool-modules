...
class CIJob(gluetool_modules.libs.dispatch_job.DispatchJenkinsJobMixin, gluetool.Module):
    """
    ...
    options = dict_update(
        {},
        gluetool_modules.libs.dispatch_job.DispatchJenkinsJobMixin.options,
        {
