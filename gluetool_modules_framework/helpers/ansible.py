...
class Ansible(gluetool.Module):
    ...
    def detect_ansible_interpreter(self, guest):
        ...
        :param gluetool_modules_framework.libs.guest.NetworkedGuest guest: Guest for auto-detection
    ...
    def run_playbook(self,
        ...
        :param gluetool_modules_framework.libs.guest.NetworkedGuest guest: Guest to run playbooks on.
