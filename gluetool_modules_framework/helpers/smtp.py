...
class SMTP(gluetool.Module):
    ...
    def _lower_message(self, message):
        ...
        :param gluetool_modules_framework.libs.mail.Message message: the message to lower.
        :rtype: MIMEText
        """
    ...
    def _send_email(self, message, lowered_message):
        ...
        :param gluetool_modules_framework.libs.mail.Message message: the message to send out.
