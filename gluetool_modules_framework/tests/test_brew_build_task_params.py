...
import gluetool_modules_framework.helpers.brew_build_task_params
...
def fixture_module():
    return create_module(gluetool_modules_framework.helpers.brew_build_task_params.BrewBuildOptions)[1]
...
def test_loadable(module):
    check_loadable(module.glue, 'gluetool_modules_framework/helpers/brew_build_task_params.py', 'BrewBuildOptions')
