...
from gluetool_modules_framework.libs.brew_build_fail import BrewBuildFailedError
from mock import MagicMock
from gluetool_modules_framework.testing.pull_request_builder import brew_builder
...
def test_loadable(module):
    check_loadable(module.glue, 'gluetool_modules_framework/testing/pull_request_builder/brew_builder.py', 'BrewBuilder')
...
def test_fail_src_rpm(tmp_path, module, monkeypatch):
    ...
    src_rpm_mock = MagicMock(
        side_effect=gluetool_modules_framework.libs.brew_build_fail.BrewBuildFailedError(
