...
def test_execute_no_coldstore_url(module, monkeypatch, log):
    monkeypatch.setattr(gluetool_modules_framework.helpers.coldstore.ColdStore, 'coldstore_url', None)
...
def test_execute_with_coldstore_url(module, monkeypatch, log):
    monkeypatch.setattr(gluetool_modules_framework.helpers.coldstore.ColdStore, 'coldstore_url', 'some-url')
