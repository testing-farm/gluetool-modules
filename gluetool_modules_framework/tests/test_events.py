...
import gluetool
import gluetool_modules_framework.helpers.events
...
def fixture_module():
    module = create_module(gluetool_modules_framework.helpers.events.Events)[1]
...
def test_loadable(module):
    ...
    check_loadable(module.glue, 'gluetool_modules_framework/helpers/events.py', 'Events')
