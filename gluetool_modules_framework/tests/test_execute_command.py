...
import gluetool
import gluetool_modules_framework.helpers.execute_command
...
def fixture_module():
    module = create_module(gluetool_modules_framework.helpers.execute_command.ExecuteCommand)[1]
...
def test_loadable(module):
    ...
    check_loadable(module.glue, 'gluetool_modules_framework/helpers/execute_command.py', 'ExecuteCommand')
