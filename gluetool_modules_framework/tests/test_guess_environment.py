...
import gluetool
import gluetool_modules_framework.helpers.guess_environment
...
def fixture_module():
    module = create_module(gluetool_modules_framework.helpers.guess_environment.GuessEnvironment)[1]
    module._compose = {
        'type': 'compose',
        'specification': 'foo',
        'method': 'foo',
...
def test_loadable(module):
    check_loadable(module.glue, 'gluetool_modules_framework/helpers/guess_environment.py', 'GuessEnvironment')
...
def test_image_pattern_map(module, monkeypatch):
    ...
    monkeypatch.setattr(gluetool_modules_framework.helpers.guess_environment, 'PatternMap', map_class)
