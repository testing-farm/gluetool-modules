...
@pytest.mark.parametrize('guest_artifacts, expected_commands, expected_filenames', [
    ...
    (
        ...
        [  # Expected install commands
            ...
            'dnf -y reinstall dummy_rpm_url1_artifact1 || true',
            'dnf -y reinstall dummy_rpm_url2_artifact1 || true',
            ...
            'dnf -y reinstall dummy_rpm_url1_artifact2 || true',
            'dnf -y reinstall dummy_rpm_url2_artifact2 || true',
            ...
            'dnf -y reinstall dummy_rpm_url1_artifact3 || true',
            'dnf -y reinstall dummy_rpm_url2_artifact3 || true',
            'dnf -y install --allowerasing dummy_rpm_url1_artifact1 dummy_rpm_url2_artifact1 dummy_rpm_url1_artifact2 dummy_rpm_url2_artifact2 dummy_rpm_url1_artifact3 dummy_rpm_url2_artifact3',
