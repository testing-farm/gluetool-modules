...
def test_guest_setup(module, monkeypatch, tmpdir, info_output):
    ...
    calls = [
        ...
        call('dnf module install --allowerasing -y {}'.format(NSVC))
    ]
    ...
    if primary_task_mock.scratch:
        calls = [
            ...
            call('dnf module install --allowerasing -y {}'.format(NSVC_SCRATCH_YUM_ENABLE_INSTALL))
        ]
...
def test_use_devel_module_and_profile(module, monkeypatch, tmpdir, info_output):
    ...
    calls = [
        ...
        call('dnf module install --allowerasing -y {}/common'.format(NSVC_DEVEL_WITH_PROFILE))
    ]
    ...
    if primary_task_mock.scratch:
        calls = [
            ...
            call('dnf module install --allowerasing -y {}/common'.format(NSVC_DEVEL_SCRATCH_YUM_ENABLE_INSTALL))
        ]
