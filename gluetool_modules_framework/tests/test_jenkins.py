...
import gluetool
import gluetool_modules_framework.infrastructure.jenkins
from gluetool_modules_framework.infrastructure.jenkins import CIJenkins, JenkinsProxy
...
def test_loadable(module):
    ...
    check_loadable(glue, 'gluetool_modules_framework/infrastructure/jenkins.py', 'CIJenkins')
