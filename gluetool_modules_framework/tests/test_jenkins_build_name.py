...
from gluetool_modules_framework.helpers.jenkins.jenkins_build_name import JenkinsBuildName
...
def test_loadable(module):
    ...
    check_loadable(glue, 'gluetool_modules_framework/helpers/jenkins/jenkins_build_name.py', 'JenkinsBuildName')
