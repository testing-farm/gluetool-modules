...
from gluetool_modules_framework.tests import *
...
def test_setup(guest, monkeypatch):
    ...
    guest._module.shared.assert_called_once_with('setup_guest', guest, variables={'UPDATE_FROM_ARTIFACTS': False}, foo=17)
