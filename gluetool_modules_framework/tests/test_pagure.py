...
import gluetool
import gluetool_modules_framework.infrastructure.pagure
from gluetool_modules_framework.infrastructure import pagure
...
def test_loadable(module):
    check_loadable(module.glue, 'gluetool_modules_framework/infrastructure/pagure.py', 'Pagure')
