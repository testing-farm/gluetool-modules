...
def test_get_final_state_error(module, evaluate, monkeypatch):
    ...
    assert module._get_final_state(AttributeError) == gluetool_modules_framework.helpers.pipeline_state_reporter.STATE_ERROR  # Ignore PEP8Bear
...
def test_init_message_thread_id(module, evaluate):
    ...
    umb_message = gluetool_modules_framework.helpers.pipeline_state_reporter.UMBMessage(module)
