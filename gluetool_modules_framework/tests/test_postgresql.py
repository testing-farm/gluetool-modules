...
import gluetool
import gluetool_modules_framework.database.postgresql
...
def fixture_module():
    return create_module(gluetool_modules_framework.database.postgresql.PostgreSQL)
...
def test_loadable(module):
    ...
    check_loadable(glue, "gluetool_modules_framework/database/postgresql.py", "PostgreSQL")
