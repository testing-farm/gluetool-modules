...
import gluetool
import gluetool_modules_framework.helpers.publisher_umb_bus
...
def fixture_module():
    ci, module = create_module(gluetool_modules_framework.helpers.publisher_umb_bus.UMBPublisher)
...
def test_loadable(module):
    ...
    check_loadable(glue, 'gluetool_modules_framework/helpers/publisher_umb_bus.py', 'UMBPublisher')
