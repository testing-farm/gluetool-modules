...
def test_reportportal_module(module, schedule, create_launch, finish_launch, log):
    ...
    assert schedule[0].testing_environment.tmt['environment']['TMT_PLUGIN_REPORT_REPORTPORTAL_UPLOAD_TO_LAUNCH'] == '12345'
...
def test_multiple_same_environments(module, schedule, create_launch, finish_launch, log):
    ...
    module.check_create_rp_launch(schedule[0])
    module.check_create_rp_launch(schedule[1])

    assert create_launch.call_count == 1

    assert schedule[0].testing_environment.tmt['environment']['TMT_PLUGIN_REPORT_REPORTPORTAL_UPLOAD_TO_LAUNCH'] == '12345'
    assert schedule[1].testing_environment.tmt['environment']['TMT_PLUGIN_REPORT_REPORTPORTAL_UPLOAD_TO_LAUNCH'] == '12345'
