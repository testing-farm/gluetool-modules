...
def test_loadable(module):
    check_loadable(module.glue, 'gluetool_modules_framework/helpers/rules_engine.py', 'RulesEngine')
...
def test_matchable_string_regex(monkeypatch, regex_method, kwargs, expected_args):
    ...
    monkeypatch.setattr('gluetool_modules_framework.helpers.rules_engine.re.{}'.format(regex_method), mock_method)
