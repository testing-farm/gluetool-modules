...
import gluetool
import gluetool_modules_framework.helpers.smtp
import gluetool_modules_framework.libs.mail
...
def fixture_module():
    return create_module(gluetool_modules_framework.helpers.smtp.SMTP)[1]
...
def fixture_mock_messages():
    mock_message = gluetool_modules_framework.libs.mail.Message(
        sender='dummy sender',
        recipients=['foo', 'bar'],
        cc=['baz']
    )
...
def test_loadable(module):
    ...
    check_loadable(module.glue, 'gluetool_modules_framework/helpers/smtp.py', 'SMTP')
