...
def test_tmt_output_copr(module, guest, monkeypatch, tmpdir):
    ...
    module_copr.setup_guest(guest, stage=GuestSetupStage.ARTIFACT_INSTALLATION, log_dirpath=str(tmpdir))
    ...
    module.glue.add_shared('dist_git_repository', module_dist_git)
    module.glue.add_shared('sut_install_commands', module_copr)
