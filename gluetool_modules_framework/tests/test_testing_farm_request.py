...
@pytest.mark.parametrize('config, expected_secrets, expected_logs', [
    ...
    (  # Normal config with `list[str]` as secret value
        {'environments': {'secrets': {'SECRET_TOKEN_KEY': ['token-invalid,base64encodedencryptedstring', 'token,base64encodedencryptedstring']}}},
        [
            {'some': 'secrets', 'SECRET_TOKEN_KEY': 'hello world'},
            {'secret_key': 'secret-value', 'SECRET_TOKEN_KEY': 'hello world'}
        ],
    ...
    (  # Invalid config
        {'envirments': {'secrets': {'SECRET_TOKEN_KEY': ['token-invalid,base64encodedencryptedstring', 'token,base64encodedencryptedstring']}}},
        [
            {'some': 'secrets'},
    ...
    (  # Invalid config
        {'environments': {'secrts': {'SECRET_TOKEN_KEY': ['token-invalid,base64encodedencryptedstring', 'token,base64encodedencryptedstring']}}},
        [
            {'some': 'secrets'},
            {'secret_key': 'secret-value'}
        ],
