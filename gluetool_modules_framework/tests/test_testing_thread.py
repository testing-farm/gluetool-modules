...
from gluetool_modules_framework.helpers.testing_thread import TestingThread
...
def test_loadable(module):
    check_loadable(module.glue, 'gluetool_modules_framework/helpers/testing_thread.py', 'TestingThread')
