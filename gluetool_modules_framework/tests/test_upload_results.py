...
def test_loadable(module):
    check_loadable(module.glue, 'gluetool_modules_framework/helpers/upload_results.py', 'UploadResults')
...
def test_upload_result(module, monkeypatch):
    ...
    monkeypatch.setattr(gluetool_modules_framework.helpers.upload_results, 'Command', mock_command)
